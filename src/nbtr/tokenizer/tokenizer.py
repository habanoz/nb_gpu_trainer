...
class Tokenizer:
    ...
    def encode_all(self, dataset, value_key):
        ...
        return dataset.map(lambda example: self.encode(example[value_key]), batched=True, batch_size=500, remove_columns=columns, desc="tokenizing the splits", num_proc=2)
