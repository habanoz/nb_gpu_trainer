...
from nbtr.train.trainer import TRAIN_DATA_FILES 
...
TEST_OUTPUT_DIR="test_output_train"
...
def test_load_data_rank_0():
    ...
    rank = 0
    local_rank=0
    ddl = DDL(TRAIN_DATA_FILES, TEST_OUTPUT_DIR, B, T, rank, local_rank, N_PROC, mock_download_wrapper())
